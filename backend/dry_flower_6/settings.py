"""
Django settings for dry_flower_6 project.
...
ROOT_URLCONF = 'dry_flower_6.urls'
...
WSGI_APPLICATION = 'dry_flower_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_flower_6 API",
    "DESCRIPTION": "API documentation for dry_flower_6 App",
    "VERSION": "v1",
}
